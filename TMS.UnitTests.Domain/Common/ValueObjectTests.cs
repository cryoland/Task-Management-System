...
namespace TMS.UnitTests.Domain.Common
{
    public class ValueObjectAtomicValuesRandomSize : ValueObject
    {
    ...
    public class ValueObjectTests : ValueObject
    {
        ...
        {
            var account1 = new ValueObjectAtomicValuesRandomSize { Size = 2 };
            var account11 = new ValueObjectAtomicValuesRandomSize { Size = 2 };
            var account2 = new ValueObjectAtomicValuesRandomSize { Size = 4 };
